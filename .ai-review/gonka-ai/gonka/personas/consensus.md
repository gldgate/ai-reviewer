...
- **Floating Point Math**: Floating-point operations can lead to slight variations across different architectures or compiler versions. Check for any usage of `float32` or `float64` in state-machine logic.
